                ...
                <div class="col-lg-7 col-md-6">
                    <div class="row">
                        <div class="col-md-6 mb-5">
                            ...
                            <p><i class="fa fa-phone-alt mr-2"></i>+7498183940</p>
                            <p><i class="fa fa-envelope mr-2"></i>vmanish1313@gmail.com</p>
                ...
                <div class="col-lg-5 col-md-6 mb-5">
                    ...
                    <div class="w-100">
                        <div class="input-group">
                            <input type="text" class="form-control border-light" style={{padding: "30px"}} placeholder="Your Email Address"></input>
        ...
        <div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5" style={{borderColor: "#3E3E4E"}}>
            <div class="row">
                <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
                    <p class="m-0 text-white">&copy; <a href="#">NK Enterprises</a>. All Rights Reserved. 
                    Designed by <a href="https://htmlcodex.com">ManishKumar Vishwakarma</a>
                    </p>
                </div>
